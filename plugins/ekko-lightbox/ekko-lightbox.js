            ...
            function Lightbox($element, config) {
                ...
                if (this._galleryName) {
                    ...
                    if (this._config.showArrows && this._$galleryItems.length > 1) {
                        this._$lightboxContainer.append('<div class="ekko-lightbox-nav-overlay"><a href="javascript:void(0);">' + this._config.leftArrow + '</a><a href="javascript:void(0);">' + this._config.rightArrow + '</a></div>');
