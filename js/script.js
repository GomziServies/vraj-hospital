...
var dropdownbtn = document.querySelectorAll('.menu-item-has-children');
dropdownbtn = Array.from(dropdownbtn);
// console.log(dropdownbtn);
var dropdown = document.querySelectorAll('.sub-menu');
dropdown = Array.from(dropdown);

for (let i in dropdownbtn) {
    dropdownbtn[i].addEventListener('click', (btn) => {
